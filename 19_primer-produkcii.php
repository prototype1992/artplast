                ...
                <div class="container">
                    ...
                    <div class="content-right">
                        ...
                        <div class="content-main">
                            <h1 class="page-title page-title--custom">Товары нашего производства</h1>

                            <div class="catalog-sort">
                                <div class="catalog-sort__left">
                                    <span>Отсортировать:</span>
                                    <a href="" class="catalog-sort__price ">по цене</a>
                                    <a href="" class="catalog-sort__articul ">по артикулу</a>
                            ...
                            <ul class="catalog-list">
                                <li class="catalog-list-item">
                                    <div class="product-item-home">
                                        <span class="product-item-home__new">Новинка</span>
                                        ...
                                        <div class="product-item-home__pod-order product-info-isset">
                                            ...
                                            <div class="block-in-stock">
                                                ...
                                                <ul class="in-stock-other">
                                                    ...
                                                    <li class="in-stock-other__item">
                                                        <a href="#" class="in-stock-other__left">Санкт-Петербург</a>
                                                    ...
                                                    <li class="in-stock-other__item">
                                                        <a href="#" class="in-stock-other__left">Екатеренбург</a>
                                                        <span class="in-stock-other__right in-stock-other__right_order">Под заказ</span>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="product-prices">
                                            <div>
                                                <label for="product-prices__label7">Штук</label>
                                                <button class="product-prices__minus"></button>
                                                <input type="text" id="product-prices__label7" class="product-prices__input" value="500">
                                            ...
                                            <div>
                                                <label for="product-prices__label8">Упаковок (100 шт)</label>
                                                <button class="product-prices__minus"></button>
                                                <input type="text" id="product-prices__label8" class="product-prices__input" value="10">
                                                <button class="product-prices__plus"></button>
                                                <span class="product-prices__x">х</span>
                                            ...
                                            <div>
                                                <label for="product-prices__label9">Упаковок (100 шт)</label>
                                                <button class="product-prices__minus"></button>
                                                <input type="text" id="product-prices__label9" class="product-prices__input" value="1">
                                                <button class="product-prices__plus"></button>
                                                <span class="product-prices__x">х</span>
                                                <span class="product-prices__price">42647,8</span>
                                            </div>
                                ...
                                <li class="catalog-list-item product-item-home_oncart">
                                    <div class="product-item-home">
                                        <a href="#" class="product-item-home__img">
                                            <img src="static/img/product-img-to-cart.jpg" alt="1">
                                        </a>
                                        <p class="product-item-home__articul">Артикул: <span>7256827</span></p>
                                        <a href="#" class="product-item-home__tobookmarks">В закладки</a>
                                        <a href='' class="product-item-home__descr">
                                        ...
                                        <div class="product-item-home__pod-order">
                                            Под заказ (<a href="">где в наличии</a>)
                                        ...
                                        <div class="btn-group">
                                            <a href="#" class="product-item-home__more">В корзине</a>
                                        </div>
                                    </div>
                                </li>
                                <li class="catalog-list-item ">
                            ...
                            <div class="other-our-product">
                                <h2 class="other-our-product__title">Другие товары нашего производства</h2>
