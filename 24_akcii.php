                ...
                <div class="container">
                    ...
                    <div class="content-right">
                        ...
                        <div class="content-main">
                            ...
                            <ul class="akcii-main">
                                <li class="akcii-main__item">
                                    <div class="akcii-main__img">
                                        <a href="">
                                            <img src="static/img/akcii-img.jpg" alt="a">
                                        </a>
                                    </div>
                                    <div class="akcii-main__content">
                                        <h3 class="akcii-main__title">
                                            <a href="">Грандиозная распродажа пленки</a>
                                        </h3>
                                        <p class="akcii-main__descr">
                                            C 1 по 3 марта компания «Артпласт» будет принимать участие в 6-й выставке
                                            оборудования, продукции и услуг для ресторанов, кафе и пекарен - FoodService /
                                            International Fast Food Fair Moscow 2016, проходящей в МВЦ «Крокус Экспо»...
                                        </p>
                                        <a href="" class="akcii-main__more">Подробнее</a>
                                    </div>
                                </li>
                                <li class="akcii-main__item">
                                    <div class="akcii-main__img">
